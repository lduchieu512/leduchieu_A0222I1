...
public class Regex {
    ...
    public static final String REGEX_SANPHAM_NK = "^(NK)-\\d{3}$";
    public static final String REGEX_SANPHAM_XK = "^(NK)-\\d{3}$";
    ...
    public static String inputRentalCosts() {
        ...
        return Uliti.Regex.regexStr(scanner.nextLine(), REGEX_RENTALCOSTS, "Bạn đã nhập sai giá thuê!, phải là số dương");
    }
   ...
   public static String inputNumber() {
    ...
    public static String inputNhapKhau() {
        return Regex.regexStr(scanner.nextLine(), REGEX_SANPHAM_NK, "Bạn đã nhập sai mã sản phẩm,mã bệnh án là NK-XXX!");
    }
    public static String inputXuatKhau() {
        return Regex.regexStr(scanner.nextLine(), REGEX_SANPHAM_XK, "Bạn đã nhập sai mã sản phẩm,mã bệnh án là XK-XXX!");
    }
