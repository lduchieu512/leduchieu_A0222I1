...
import Hospital.HospitalUliti.AgeCheckingExeption;
...
public class Regex {
    ...
    public static String checkName(){return regexStr(scanner.nextLine(),REGEX_STR,"Nhập sai");}
   ...
   public static String inputNumber() {
    ...
    public static String inputDay() {return Regex.regexDay(scanner.nextLine(), REGEX_BIRTHDAY);}
}
