...
public class Regex {
    ...
    public static final String REGEX_BENH_AN = "^(BN)-\\d{3}$";
   ...
   public static String inputNumber() {
    ...
    public static String inputBenhAn() {
        return Regex.regexStr(scanner.nextLine(), REGEX_BENH_AN, "Bạn đã nhập sai mã bệnh án,mã bệnh án là BN-XXX!");
    }
